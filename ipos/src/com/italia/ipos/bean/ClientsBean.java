...
public class ClientsBean implements Serializable {
	...
	private List<CustomerPayment> customers = new ArrayList<CustomerPayment>();
	...
	private List<CustomerPayment> customerPays = new ArrayList<CustomerPayment>();
	private String hisDateFrom;
	private String hisDateTo;
	private String hisName;
	
	private List<CustomerPaymentTrans> historys = new ArrayList<CustomerPaymentTrans>();
	private String hisTotal;
	private CustomerPayment customerPaymentData;
	
	private List<Customer> rents = new ArrayList<Customer>();
	private String searchClientsRented;
	
	private List<Customer> rentHistory = new ArrayList<Customer>();
	private String searchClientsRentedHistory;
	
	private List<Customer> returns = new ArrayList<Customer>();
	private String searchClientsReturn;
	
	private List<ReturnRentedItems> returnHistory = new ArrayList<ReturnRentedItems>();
	private String searchClientsReturnHistory;
	private Date returnHistoryDateFrom;
	private Date returnHistoryDateTo;
	
	private List<Customer> customerReceipts = new ArrayList<Customer>();
	...
	private List<Transactions> transReceipt = new ArrayList<Transactions>();
	...
	public void startPaymnets(){
		customers = new ArrayList<CustomerPayment>();
	...
	public void loadCustomerReceipt() {
		transReceipt = new ArrayList<Transactions>();
	...
	public void startHistory(){
		customerPays = new ArrayList<CustomerPayment>();
	...
	public void loadPaymentHistory(){
		historys = new ArrayList<CustomerPaymentTrans>();
	...
	public void startBought(){
		...
		customerReceipts = new ArrayList<Customer>();
		List<DeliveryItemReceipt> receipts = new ArrayList<DeliveryItemReceipt>();
		...
		List<Customer> searchCustomer = new ArrayList<Customer>();
	...
	public void startRented(){
		rents = new ArrayList<Customer>();
		List<RentedBottle>	bottles = new ArrayList<RentedBottle>();
		...
		for(Customer customer : searchCustomer){
			...
			cz.setIsactive(1);
			cz.setCustomerid(customer.getCustomerid());
			bottles = new ArrayList<RentedBottle>();
			boolean isExist = false;
	...
	public void startRentedHistory(){
		rentHistory = new ArrayList<Customer>();
		List<RentedBottle>	bottles = new ArrayList<RentedBottle>();
	...
	returns = new ArrayList<Customer>();
	List<RentedBottle>	bottles = new ArrayList<RentedBottle>();
	...
	public void startReturnHistory(){
		returnHistory = new ArrayList<ReturnRentedItems>();
