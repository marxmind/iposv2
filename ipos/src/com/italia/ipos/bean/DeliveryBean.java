...
public class DeliveryBean implements Serializable{
	...
	private List<SupplierItem> items = new ArrayList<SupplierItem>();
	...
	private List<SupplierItem> addSelectedItemsData = new ArrayList<SupplierItem>();
	private List<SupplierTrans> trans = new ArrayList<SupplierTrans>();
	...
	private List<DeliveryItemTrans> itemSolds = new ArrayList<DeliveryItemTrans>();
	...
	private List<DeliveryItemTrans> soldProductItem = new ArrayList<DeliveryItemTrans>();
	...
	private List<RentedBottleTrans> rentedItems = new ArrayList<RentedBottleTrans>();
	...
	private List<RentedBottleTrans> selectedRentedTrans = new ArrayList<RentedBottleTrans>();
	...
	public void loadSoldItem(){
		if(getReceiptData()!=null){
			...
			recpt.setIsActive(1);
			itemSolds = new ArrayList<DeliveryItemTrans>();
	...
	public void loadSoldProductOnly(){
		soldProductItem = new ArrayList<DeliveryItemTrans>();
	...
	public void loadRented(){
		rentedItems = new ArrayList<RentedBottleTrans>();
