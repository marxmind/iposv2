...
public class SupplierTransBean implements Serializable {
	...
	private List<Supplier> sups = new ArrayList<Supplier>();
	...
	private List<ProductReturnSupplier> returns = new ArrayList<ProductReturnSupplier>();
	private List<ProductReturnSupplier> returnDataPosting =  new ArrayList<ProductReturnSupplier>();
	private Map<Long, ProductInventory> inventoryData = new HashMap<Long, ProductInventory>();
	...
	public void initReturned(){
		returns = new ArrayList<ProductReturnSupplier>();
	...
	public void clickItem(Supplier sup){
		...
		setSupplier(sup);
		items = new ArrayList<SupplierItem>();
		trans = new ArrayList<SupplierTrans>();
		SupplierTrans tran = new SupplierTrans();
		tran.setIsActive(1);
		tran.setStatus(1);
		Supplier sp = new Supplier();
		...
		for(SupplierTrans t :  SupplierTrans.retrieve(tran,sp)){
			...
			tr.setStatus(1);
			double amnt = 0d;
			List<SupplierPayment> payments = new ArrayList<SupplierPayment>();
			for(SupplierPayment py : SupplierPayment.retrieve(pay,tr)){
				amnt += py.getAmount();
	...
	public void loadReturnListBox(){
		...
		inventoryData = new HashMap<Long, ProductInventory>(); 
		Product prod = new Product();
		prod.setIsactiveproduct(1);
