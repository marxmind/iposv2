...
public class CashRegBean implements Serializable{
	...
	@Setter @Getter private String inputReader;
	@Setter @Getter private List<StoreProduct> items = new ArrayList<StoreProduct>();
	@Setter @Getter private Map<Long, StoreProduct> mapItems = new LinkedHashMap<Long, StoreProduct>();
