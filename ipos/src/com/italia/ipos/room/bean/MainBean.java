...
public class MainBean implements Serializable{
	...
	private List<Rooms> availableRooms = new ArrayList<Rooms>();
	private String searchAvailableRoom;
	
	private List<Rooms> occupiedRooms = new ArrayList<Rooms>();
	...
	private List<Rooms> outRooms = new ArrayList<Rooms>();
	...
	private void loadPrintReceipt(String[] vals){
		...
		List<PrintFields> pfs = new ArrayList<PrintFields>();
	...
	public void loadOccupiedRooms(){
		occupiedRooms = new ArrayList<Rooms>();
