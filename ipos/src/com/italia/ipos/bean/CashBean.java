...
public class CashBean implements Serializable{//old name CashierBean
	...
	private List<StoreProduct> prods = new ArrayList<StoreProduct>();
	private String qtyToCart;
	private String qtyToCartTmp;
	private Map<Long, PurchasedItem> productPurchasedData = new HashMap<Long,PurchasedItem>();
	private List<PurchasedItem> orders = new ArrayList<PurchasedItem>();
	...
	private Map<Long,QtyRunning> qtyrunning = new HashMap<Long,QtyRunning>();
	
	private String businessName;
	
	private List<ProductRunning> productHolds = new ArrayList<ProductRunning>();
	...
	private List<AddOnStore> xtras = new ArrayList<AddOnStore>();
	...
	private List<StoreProduct> prodReturn = new ArrayList<StoreProduct>();
...
public double getItemCount() {
	...
	public String getReceiptView() {
		...
		if(receiptView==null){
			...
			return receiptView.replace("null", "");
	}
   ...
   public String getKeyPress() {
	...
	public void initReturn(){
		...
		prodReturn = new ArrayList<StoreProduct>();
...
public void printSalesInvoice(Transactions transactions){
	...
	List<com.italia.ipos.controller.Reports> reports = new ArrayList<com.italia.ipos.controller.Reports>();
